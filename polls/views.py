...
# A ListView is one of the generic views in Django.
class IndexView(generic.ListView):
  ...
  # Default template: polls/Question_list.html
  template_name = "polls/index.html"

  # -Verify the accuracy of the following:
  # In a ListView, a context variable is automatically
  # generated. The default name for that context variable
  # would be "question_list". To override this default
  # name, "latest_question_list" was assigned to
  # the "context_object_name" attribute.

  # "latest_question_list" will automatically be
  # accessible inside of "polls/index.html".
  ...
  def get_queryset(self):
    ...
    # print(f"\ntype(timezone.now(): {type(timezone.now())}\n")
    ...
    """Return the last five published questions (not
       ...
       is less than or equal to the value returned by timezone.now().
       
       The lte lookup is used to get records that are less than,
       or equal to, a specified value.
    """
    print("Questions to be returned:", Question.objects.filter(
...
class DetailView(generic.DetailView):
  ...
  The default template name would be "polls/question_detail.html".
...
# Handles HTTP responses containing a 404 status code.
def page_not_found(request, exception=None):
  # send_mail(
  #   "404 Status Code in HTTP Response",
  #   "404 HTTP response received.",
  #   "from@example.com",
  #   ["dennisgurban44@gmail.com"],
  #   fail_silently=False,
  # )
  return render(request, "polls/page_not_found.html")

# Handles HTTP responses containing a 500 status code.
def internal_server_error(request, exception=None):
  # send_mail(
  #   "500 Status Code in HTTP Response",
  #   "500 HTTP response received.",
  #   "from@example.com",
  #   ["dennisgurban44@gmail.com"],
  #   fail_silently=False,
  # )
  return render(request, "polls/internal_server_error.html")

def errors(request):
  return render(request, 'polls/errors.html')

# Artificially generates a 404 HTTP exception.
def generate_404(request):
  raise Http404()

# Artificially generates a 500 HTTP exception.
